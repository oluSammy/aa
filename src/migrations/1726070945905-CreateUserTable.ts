...
export class CreateUserTable1726070945905 implements MigrationInterface {
    name = 'CreateUserTable1726070945905'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`wallet\` ADD UNIQUE INDEX \`IDX_a2cb5718693f24a06c8d419f24\` (\`user_id_id\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`wallet\` DROP INDEX \`IDX_a2cb5718693f24a06c8d419f24\``);
